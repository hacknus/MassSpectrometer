...
amu_max=2
for i in delta_ms:
    amu,p,err = sequences("restgasspektrum_FARx7_{}prozent.csv".format(i),False,combine,amu_min,amu_max,relative,False)
    ax1.plot(amu,p)
...
for i in delta_ms:
    amu,p,err = sequences("restgasspektrum_FARx7_{}prozent.csv".format(i),False,combine,amu_min,amu_max,relative,False)
    ax2.plot(amu,p,label=r'$\Delta_m = {}%$'.format(i))
...
fig.suptitle(r'variation of $\Delta$m')
plt.tight_layout()
...
for i in delta_ms:
    amu,p,err = sequences("restgasspektrum_FARx7_{}prozent.csv".format(i),False,combine,amu_min,amu_max,relative,False)
    ax3.plot(amu,p, label=r'$\Delta_m = {}%$'.format(i))
...
for i in delta_ms:
    amu,p,err = sequences("restgasspektrum_FARx7_{}prozent.csv".format(i),False,combine,amu_min,amu_max,relative,False)
    ax4.plot(amu,p, label=r'$\Delta_m = {}%$'.format(i))
...
fig.suptitle(r'variation of $\Delta$m')
plt.tight_layout()
plt.savefig("Report/DataResultsPlots/delta_m_variation_N2_and_O2.pdf")
plt.plot()
...
for i in delta_ms:
    amu,p,err = sequences("restgasspektrum_FARx7_{}prozent.csv".format(i),False,combine,amu_min,amu_max,relative,False)
    ax5.plot(amu,p, label=r'$\Delta_m = {}%$'.format(i))
...
fig.suptitle(r'variation of $\Delta$m')
plt.tight_layout()
plt.savefig("Report/DataResultsPlots/delta_m_variation_CO2.pdf")
plt.plot()
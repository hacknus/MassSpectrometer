...
\begin{circuitikz}
    ...
    \draw[ultra thick, ->] (5, -2) to (5.75,-2) to (5.75, -0.2);
    ...
    \draw[ultra thick] (4,-2) to (2,-2);
    \draw[ultra thick, -{angle 90 reversed}] (1,-2) to (0,-2);
    \node at (-1.5,-2) {Sample inlet};
    \draw[ultra thick] (3,-2) to (3,-3);
    ...
    \draw[ultra thick, ->] (3,-4) to (3,-4.8);
    
    \draw[ultra thick] (3,-6) circle (1);
    \node at (3,-6.3) {Pump 2};
    \node at (3,-5.7) {Vacuum};

    
    \draw[thick, red] (4,2.2) to (4, 3);
    \node[red] at (4,3.5) {Heater 1};

    \draw[ultra thick] (0,0) rectangle (5,2);
    \node at (2.5,1) {Mass-Spectrometer};

    \draw[ultra thick] (5.5,0) rectangle (6 ,2);

    \draw[thick,->] (6,1.5) to (-0.7,1.5) to (-0.7,1);
    \draw[ultra thick] (6,1.5) to (6.5,1.5);
    \draw[ultra thick] (6.5,1.3) to (6.5,1.7);
    \filldraw[white] (6,1.5) circle (0.15);
    \draw[thick, black] (6,1.5) circle (0.15);
    \node at (7.8,1.5) {V5 Bypass};
    
    \draw[thick, ->] (6,0.5) to (4.5,0.5);
    \draw[ultra thick] (6,0.5) to (6.5,0.5);
    \draw[ultra thick] (6.5,0.3) to (6.5,0.7);
    \filldraw[white] (6,0.5) circle (0.15);
    \draw[thick, black] (6,0.5) circle (0.15);
    \node at (7.8,0.5) {V4 Input};
    
    \draw[ultra thick] (5.5,1) to (5,1);

    \draw[ultra thick, ->] (0,1) to (-1.8,1);
    \draw[ultra thick] (-3,1) circle (1);
    \node at (-3, 0.7) {Pump 1};
    \node at (-3, 1.3) {Vacuum};
    

    \draw[ultra thick, <->, dashed] (2.5,2.2) to (2.5,4) to (-1.8,4);

...
frac_xe_err = np.round(
    np.sqrt(((1 / s) ** 2 - p_xe / s ** 3) * p_xe_err ** 2 + (p_xe / s ** 2) ** 2 * s_err ** 2) * 100, 2)
...
frac_kr_err = np.round(
    np.sqrt(((1 / s) ** 2 - p_kr / s ** 3) * p_kr_err ** 2 + (p_kr / s ** 2) ** 2 * s_err ** 2) * 100, 2)
...
frac_ar_err = np.round(
    np.sqrt(((1 / s) ** 2 - p_ar / s ** 3) * p_ar_err ** 2 + (p_ar / s ** 2) ** 2 * s_err ** 2) * 100, 2)
